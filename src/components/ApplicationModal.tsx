    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(
                `https://${PROJECT_ID}.supabase.co/functions/v1/make-server-b5548700/applications`,
                {
                    method: "POST",
                    headers: {
                            ...
                            >
                                ...
                                <div className="flex gap-4 mt-8">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isSubmitting}
                                        className="flex-1 px-6 py-3 rounded-xl bg-linear-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold transition-all shadow-lg shadow-cyan-500/30 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {isSubmitting
                                            ? "제출 중..."
                                            : "신청하기"}
                ...
                <>
                    ...
                    <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
                        <motion.div
                            ...
                            className="relative w-full max-w-md rounded-2xl border border-cyan-500/50 bg-linear-to-br from-slate-900 to-slate-800 p-8 text-center shadow-2xl shadow-cyan-500/30"
                        >
                            {/* Success Icon */}
                            <motion.div
                                initial={{ scale: 0 }}
                                ...
                                className="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full bg-linear-to-br from-cyan-500 to-blue-500 shadow-lg shadow-cyan-500/50"
                            >
                            ...
                            <button
                                onClick={() => setShowSuccess(false)}
                                className="w-full rounded-xl bg-linear-to-r from-cyan-500 to-blue-500 px-6 py-3 text-white font-bold transition-all shadow-lg shadow-cyan-500/30 cursor-pointer hover:from-cyan-600 hover:to-blue-600"
                            >
                                확인
                            </button>
                        </motion.div>
