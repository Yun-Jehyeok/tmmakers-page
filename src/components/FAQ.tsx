...
const faqs: FAQItem[] = [
    {
        ...
        answer: "네, 프로그래밍을 전혀 모르셔도 참여가 가능합니다.",
    },
    {
        question: "취업이 보장되나요?",
        answer: "보장되지 않습니다. 이는 어느 교육을 듣더라도 마찬가지이며, 개인의 문제가 아닌 얼어붙은 취업 시장의 문제입니다. 하지만 진짜 취업을 위한 내용들을 진행함으로써 제대로 된 방향으로 달려나가실 수 있도록 도와드립니다.",
    },
    {
        question: "부트캠프와 다른게 있나요?",
        answer: "웹사이트 몇개 만들고 취업이 되는 시대는 끝났습니다. 성능 최적화(Ex. 로딩 속도 개선), 기술에 대한 된 고민, 코딩테스트, 기술 면접 준비 등 부트캠프에선 다루지 않는, 진짜 프론트엔드 개발자가 되기 위해 필요한 내용들을 가르칩니다.",
    },
    {
        question: "재직/재학 중 참여가 가능한가요?",
        answer: "재직중엔 참여가 불가능하지만 재학 중엔 참여가 가능합니다. 녹화가 필요한 내용들은 녹화본이 제공됩니다.",
    },
    {
        question: "교육 시간에 참여가 어려운데 녹화 영상을 볼 수 있나요?",
        answer: "녹화가 필요한 내용들은 녹화되며, 수강생들에게 제공됩니다.",
    },
    {
    ...
    },
    {
        ...
        answer: "올바른 방향성을 제시드립니다. 혼자 공부하실 때는 어디서부터 시작해야할지, 어떤 내용을 공부해야할지 막막할 수 있습니다. 멘토링을 통해 올바른 방향성을 제시드리고, 취업에 필요한 내용들을 가르쳐드립니다.",
    },
];
        ...
        <div className="relative w-full bg-gradient-to-br from-slate-950 via-slate-900 to-black py-20 px-4">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="mt-12 text-center p-8 rounded-2xl bg-gradient-to-br from-cyan-500/10 via-blue-500/10 to-cyan-500/10 border-2 border-cyan-400/30 max-md:mb-32"
                >
