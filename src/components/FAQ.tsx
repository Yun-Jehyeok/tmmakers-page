...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "네, 프로그래밍을 전혀 모르셔도 기초 트랙으로 참여가 가능합니다.",
  },
  {
    question: "수료 후 취업이 보장되나요?",
    answer:
      "보장되지 않습니다. 이는 어느 교육을 듣더라도 마찬가지이며, 개인의 문제가 아닌 얼어붙은 취업 시장의 문제입니다. 하지만 저희는 타 교육에서 진행하지 않는, 진짜 취업을 위한 내용들을 진행함으로써 제대로 된 방향으로 달려나가실 수 있도록 도와드립니다.",
  },
  {
    question: "부트캠프와 다른게 있나요?",
    answer:
      "웹사이트 몇개 만들고 취업이 되는 시대는 끝났습니다. 만든 작업물에 대한 성능 최적화(Ex. 로딩 속도 개선), 사용하는 기술에 대한 제대로 된 고민, 코딩테스트, 기술 면접 준비 등 부트캠프에선 다루지 않는, 진짜 프론트엔드 개발자가 되기 위해 필요한 내용들을 가르칩니다.",
  },
  {
    question: "온라인 과정은 없나요?",
    answer:
      "네, 전 과정은 오프라인으로 진행됩니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "취업 트랙의 모든 세션은 녹화되며, 수강생들에게 제공됩니다. 다만 기초/프로젝트 트랙은 녹화 영상이 제공되지 않습니다.",
  },
  {
    question: "환불 정책은 어떻게 되나요?",
    answer:
      "교육 시작 1주일 전까지는 100% 환불이 가능하며, 교육 시작 후 1주일 이내에는 70% 환불이 가능합니다. 그 이후에는 환불이 어려우니 신중하게 결정해주시기 바랍니다.",
  },
  {
    question: "멘토링 이수 후 어떤 지원을 받을 수 있나요?",
    answer:
      "이수 후에도 커뮤니티를 통한 네트워킹, 추가 학습 자료 제공, 취업 상담 등의 지원이 계속됩니다.",
  },
  {
    question: "준비물이나 사전 설치가 필요한 프로그램이 있나요?",
    answer:
      "개인 노트북(Mac 또는 Windows)이 필요합니다. 노트북은 지원되지 않습니다.",
  },
  {
    question: "혼자 학습하는 것과 멘토링의 차이점은 무엇인가요?",
    answer:
      "시간입니다. 혼자 학습하시는 것에 비해 최소 2배의 시간은 아끼실 수 있으며, 타 부트캠프 수료 후에도 취업을 위해선 반드시 혼자 학습하는 시간이 필요합니다.",
  },
];
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full p-4 sm:p-6 flex items-start justify-between gap-4 text-left group cursor-pointer"
              >
